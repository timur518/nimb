...
class AdminPanelProvider extends PanelProvider
{
                ...
                return $builder
                    ...
                    ->groups([
                        ...
                        NavigationGroup::make()
                            ...
                            ->items(FilamentMenuLoader::make('systemsettings')),
                    ])
                    // Use Directly
    ...
    private function getPlugins(): array
    {
        $plugins = [
            ...
            SpatieLaravelTranslatablePlugin::make()->defaultLocales(['ru']),
            ...
            BreezyCore::make()
                ->myProfile(
                    ...
                    navigationGroup: 'Настройки', // Sets the navigation group for the My Profile page (default = null)
